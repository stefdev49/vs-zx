...
const keywords_1 = require("syntax-definitions/keywords");
...
function convertToBinary(basicText) {
...
function tokenizeLine(line) {
    ...
    while (i < line.length) {
        ...
        const sortedKeywords = keywords_1.allKeywords.sort((a, b) => b.length - a.length);
