...
170 LET ix=1: IF r$="y" THEN GO TO 210
180 IF r$="Y" THEN GO TO 210
190 LET ix=2: IF r$="n" THEN GO TO 210
200 IF r$<>"N" THEN GO TO 150
210 LET c=a(c,ix): GO TO 140
300 REM animal
