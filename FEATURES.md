...
| **Code Actions**         | Add/renumber line numbers, insert missing RETURN/NEXT, suggest DIM, uppercase keywords, extract variables, extract subroutines.                                                                   |
...
| ✅ Completed | **Advanced Refactorings**     | Implemented transformations including extracting subroutines and variables with proper line numbering and code formatting.                                                         | ✅ Extract Variable: Extract expressions to variables with proper line numbering and spacing                                                                                                                                                                                                |

✅ Extract Subroutine: Move code blocks to subroutines at end of program with GOSUB calls
✅ Automatic line renumbering and code formatting |
